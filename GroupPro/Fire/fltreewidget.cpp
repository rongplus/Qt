...
void FLTreeWidget::addNode(FLJob* pJob)
{
	...
	jobItem->setIcon(0,QIcon(":/firelink/Resources/icons/dialog-icon.png"));
...
void FLTreeWidget::addNode(QTreeWidgetItem *pParentItem,FLFloor* pFloor)
{
	...
	floorItem->setIcon(0,QIcon(":/firelink/Resources/icons/network.png"));
...
void FLTreeWidget::addNode(QTreeWidgetItem *pParentItem,FLWio* pWio)
{
	...
	wioItem->setIcon(0,QIcon(":/firelink/Resources/icons/wio.png"));
...
void FLTreeWidget::addNode(QTreeWidgetItem *pParentItem,FLObject* pObj)
{
	...
	ioItem->setIcon(0,QIcon(":/firelink/Resources/icons/" + strIcon));
...
void FLTreeWidget::addNode(QTreeWidgetItem *pParentItem, FLZoneControllor* pZC)
{
	...
	zcItem->setIcon(0,QIcon(":/firelink/Resources/icons/zc.png"));
	...
	remoteTrItem->setIcon(0,QIcon(":/firelink/Resources/icons/trouble-icon-48.png"));

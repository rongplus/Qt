...
void FLCreateZCDlg::Init(FLZoneControllor* pZC)
{
	...
	m_pwioItem->setIcon(0,QIcon(":/firelink/Resources/icons/wio-icon-48.png"));
...
void FLCreateZCDlg::onAdd()
{
	...
	if(dlg.exec() == QDialog::Accepted)
	{
		...
		pItem->setIcon(0,QIcon(":/firelink/Resources/icons/wio-icon-48.png"));
